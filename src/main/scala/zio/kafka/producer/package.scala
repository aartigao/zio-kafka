...
package object producer {
  ...
  object Producer {
     ...
     */
    def flush[R: Tag, K: Tag, V: Tag]: RIO[R with Blocking with Producer[R, K, V], Unit] =
      withProducerService(_.flush)

    /**
     * Accessor method for [[Service.metrics]]
     */
    def metrics[R: Tag, K: Tag, V: Tag]: RIO[R with Blocking with Producer[R, K, V], Map[MetricName, Metric]] =
